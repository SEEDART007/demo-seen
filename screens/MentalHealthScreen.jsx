  ...
  const sendMessageToAI = async () => {
    ...
    try {
      const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
        method: 'POST',
        headers: {
          'Authorization': 'Bearer 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', // Replace with your key
      ...
      const aiReply = data.choices?.[0]?.message?.content || "I'm here to support you.";
      setChatMessages((prev) => [...prev, { from: 'bot', text: aiReply }]);
    } catch (err) {
      console.error("❌ AI Error:", err);
      setChatMessages((prev) => [...prev, { from: 'bot', text: 'Unable to connect to AI at the moment.' }]);
    } finally {
